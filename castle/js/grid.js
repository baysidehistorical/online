$(function() {
  ...
  Template = (function() {
    ...
    $ibImgItems	= $ibItems.not('.ib-content, .ib-detail'),
    ...
    init	= function() {
      ...
      console.log('Total items: ' + $ibItems.length);
      console.log('Total image items: ' + imgItemsCount);
      console.log('Total detail items: ' + $ibWrapper.find('.ib-detail, .ib-content').length);
    },
    loadKinetic	= function() {
      setWrapperSize();
      $ibWrapper.kinetic({
        moved	: function() { kinetic_moving = true; },
        stopped	: function() { kinetic_moving = false; }
      });
    },
    ...
    openItem	= function( $item ) {
      ...
      // if content item
      if( $item.hasClass('ib-content') || $item.hasClass('ib-detail')) {
        isAnimating	= true;
    ...
    loadContentItem	= function( $item, callback ) {
      ...
      console.log( $('#ib-content-preview').length + ' , ' + hasContentPreview);
